...
var _preventExtensions = __webpack_require__(107);
...
var _toStringTag = __webpack_require__(72);

var _toStringTag2 = _interopRequireDefault(_toStringTag);

var _isFrozen = __webpack_require__(122);
...
var _setImmediate2 = __webpack_require__(134);
...
var _ownKeys = __webpack_require__(152);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(35), __webpack_require__(87)))
...
$export($export.S + $export.F * !__webpack_require__(6), 'Object', { defineProperties: __webpack_require__(59) });
...
var objectAssert = {
  assert: function assert(value) {
    return typeof value === 'function' || (typeof value === 'undefined' ? 'undefined' : (0, _typeof3.default)(value)) === 'object' && typeof value.handler === 'function';
  },
...
function assertRawModule(path, rawModule) {
  (0, _keys2.default)(assertTypes).forEach(function (key) {
    if (!rawModule[key]) {
      return;
    }
...
function makeAssertionMessage(path, key, type, value, expected) {
  ...
  buf += " is " + (0, _stringify2.default)(value) + ".";
  return buf;
}
...
(function (global, factory) {
  ...
  var Zepto = function () {
    ...
    $.isNumeric = function (val) {
      var num = Number(val),
          type = typeof val === 'undefined' ? 'undefined' : (0, _typeof3.default)(val);
    ...
    $.fn = {
      ...
      closest: function closest(selector, context) {
        var nodes = [],
            collection = (typeof selector === 'undefined' ? 'undefined' : (0, _typeof3.default)(selector)) == 'object' && $(selector);
